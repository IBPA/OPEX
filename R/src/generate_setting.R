...
#'   add: the number of samples added in each iteration.
#'   data: the id for the dataset used. Because we tested the method on seven synthetic dataset and one RNA-seq dataset. dataset 1-7 are synthetic and dataset 8 is the RNA-seq.
