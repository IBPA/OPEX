...
df_MI_Diff <- (df_Random - df[df$method == OED_Method_Name, c(1:num_iter)])/df_Random
...
df_summ_OED <- get_summary(df_MI_Diff, "OED")
...
df_Random <- df[df$method == "Random", c(1:num_iter)]
df_MI_Diff <- (df_Random - df[df$method == OED_Method_Name, c(1:num_iter)])
