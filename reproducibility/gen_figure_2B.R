...
#       between the random and OED methods (iteration 23)
...
# 7) Plot the boxplot for number of iterations necessary to achive error of OED at iteration 15 (MAE=0.147)
...
print(gComb)
ggsave("./figures/figure_2B.pdf", gComb, dpi = 600, width=5 , height =  3.5)
